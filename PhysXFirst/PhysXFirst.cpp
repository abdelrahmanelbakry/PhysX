...
//vector<LPD3DXMESH>  g_pCubeMesh     = NULL;
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
    ...
    DXUTCreateWindow( L"PhysXFirst" );

    // Only require 10-level hardware, change to D3D_FEATURE_LEVEL_11_0 to require 11-class hardware
    // Switch to D3D_FEATURE_LEVEL_9_x for 10level9 hardware
    DXUTCreateDevice( D3D_FEATURE_LEVEL_10_0, true, 640, 480 );
	
	//intializae Our Physics
	InitPhysics();
                                     ...
                                     void* pUserContext )
{
	...
	//Loading Our Cube Mesh
	LPD3DXMESH pTempCubeMesh = NULL;
    LPDIRECT3DVERTEXBUFFER9 pTempVertexBuffer;
	
	
	D3DXLoadMeshFromX( "cube3.x", D3DXMESH_SYSTEMMEM, pd3dDevice,
                       NULL, NULL, NULL, NULL, &pTempCubeMesh );

    pTempCubeMesh->CloneMeshFVF( 0, Vertex::FVF_Flags,pd3dDevice, &g_pCubeMesh );
                                 ...
                                 float fElapsedTime, void* pUserContext )
{
    ...
    int numActors = gScene->getNbActors();  // Get the total number of actors. 
    NxActor** actors = gScene->getActors(); // Get the actors as an array of actor pointers
    float d3dMat[16];
